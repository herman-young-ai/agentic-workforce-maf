...
public static class GetCostTimeline
{
    public static void MapEndpoints(IEndpointRouteBuilder app) =>
        app.MapGet("/api/v1/projects/{projectId:guid}/costs/timeline", HandleAsync)
        ...
        CancellationToken ct)
    {
        ...
        var timeline = await svc.GetTimelineAsync(projectId, from, to, ct);
